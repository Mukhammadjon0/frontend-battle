...
if (current == "English") {
  document.head.innerHTML +=
    "<style type='text/css' class='en-flag'>.current:after { background:url('./assets/svg/united.svg') no-repeat; background-position: center; background-size: contain !important; }</style>";
}

if (current == "O'zbekcha") {
  document.head.innerHTML +=
    "<style type='text/css' class='uz-flag'>.current:after { background:url('./assets/svg/uzbekistn.svg') no-repeat; background-position: center; background-size: contain !important; }</style>";
}
...
document
  ...
  .addEventListener("DOMSubtreeModified", function (e) {
    console.log(e);
    if (document.querySelector(".current").textContent == "O'zbekcha") {
    ...
    if (document.querySelector(".current").textContent == "English") {
      ...
      document.head.innerHTML +=
        "<style type='text/css' class='uz-flag'>.current:after { background:url('./assets/svg/united.svg') no-repeat; background-position: center; background-size: contain !important; }</style>";
    }
  });
